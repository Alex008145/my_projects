...
console.log('Jonas Schmadtman'.split(' '));

const [firstName, lastName] = 'Jonas Schmadtman'.split(' ');
...
capitalizeName('jonas schmadtmann');
...
console.log(maskCreditCard(451353521535));
console.log(maskCreditCard('53435626467573535'));
...
console.log(airline.slice(airline.indexOf('T'), airline.indexOf(' ')));
...
/*
const rest = new Map();
rest.set('name', 'Clssico Italiano');
...
const printGoals = function (...players) {
  ...
  console.log(`${game.scored[0]} made 2 goals`);
  console.log(`${game.scored[1]} made 1 goal`);
  console.log(`${game.scored[3]} made 1 goal`);
};
...
const textToCamel = function (text) {
  const textLower = text.Lowe;
};
